...
namespace AutoTest1
{
    public class checkBoxDemo
    {
        ...
        public static void Test3ManyCheckboxes()
        {
            ...
            //IWebElement resultEl = driver.FindElement(By.Id("check1"));
            //if (resultEl = true)
            //{
            //ClickOnCheckbox(false);
            // }
            ...
            IWebElement button = driver.FindElement(By.Id("check1"));
            Assert.IsTrue("Check All".Equals(button.GetAttribute("value")), "Text is not correct");
        }

        /*private static void ClickOnCheckboxs(bool shouldBeCheck)
        {
           IWebElement firstCheckbox = driver.FindElement(By.Id("isAgeSelected"));
            if (firstCheckbox.Selected == shouldBeCheck)
            {
